...
export enum CDN_URL {
  BASE = 'https://chat-app-file-store.s3.ap-south-1.amazonaws.com/',
  ORIGINAL = 'https://chat-app-file-store.s3.ap-south-1.amazonaws.com/original/',
  PREVIEW = 'https://chat-app-file-store.s3.ap-south-1.amazonaws.com/preview/'
}
